<x-admin-layout>
    ...
    <center>
        <div class="card card-primary card-outline" style="width:65%;">
           ...
           <!-- form start -->
           <form action="{{ route('admin.settings.rooms.update',$Room->id) }}" class=" " method="POST" >
               @csrf
               @method('PUT')
             ...
             <div class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><input required  type="number" name="room_number"   value="{{ $Room->room_number ?? old('room_number') }}"   class="form-control"> </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select id='category_id' class="form-control" name="category_id" required>
                                            ...
                                            @foreach($RoomCategories as $RoomCategory)
                                                <option value="{{ $RoomCategory->id }}" {{ (isset($Room) && $Room->category_id == $RoomCategory->id) || old('category_id') == $RoomCategory->id ? 'selected' : '' }}>
                                                    {{ $RoomCategory->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div id="show_room_class_info">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $Room->category->weekday_price }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Weekend Price({!! env('CURRENCY_SIGN') !!})</b></td>
                                        <td>{{ $Room->category->weekend_price }} </td>
                                    </tr>
                                    </tbody>
                                </table>
